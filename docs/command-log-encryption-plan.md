...
1) **Crypto utilities**: add RFC 8785 canonical JSON encoding (use `canonicalize` or `json-canonicalize`), base64url helpers, SHA-256, HKDF, AES-GCM, Ed25519 + X25519 using `@noble/curves`, with unit tests (`apps/web/src/crypto/*`).
